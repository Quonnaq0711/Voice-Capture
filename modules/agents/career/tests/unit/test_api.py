...
from backend.voice_capture.api.vc import router, send_message, get_career_insights
from backend.voice_capture.api.vc import ChatRequest, CareerInsightsResponse
